      ...
      <div className="container">
        <div className="row">
          ...
          <div className="box col-sm">
            ...
            <b>Toppglaciär:</b>
            <p>Glaciär som finns på bergstopp. </p> 
            <b>Nischglaciär:</b>
            <p>Glaciär som ligger i en gryta eller skål. </p>
            <b>Isfält:</b>
            <p>En stor glaciär flytandes åt flera håll. </p>
            <b>Inlandsis:</b>
            <p>Ett mycket stort isfält som täcker hela kontinenter. </p>
            <b>Dalglaciär:</b>
            <p>En glaciär som flyter fram längs en dal. </p>
            <b>Piedmontglaciär:</b>
            <p>En glaciär som rinner ut och breder ut sig på låglandområden
